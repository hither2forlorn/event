...
// ─── Artist/personal-vendor detail ────────────────────────────────────────
export const CreateArtistDetailSchema = z.object({
...
export const CreateFullBusinessSchema = CreateBusinessSchema.extend({
    ...
    artist_detail: CreateArtistDetailSchema.optional(),
});
...
export type CreateArtistDetailType = z.infer<typeof CreateArtistDetailSchema>;
