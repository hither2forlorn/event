...
export interface VehicleWithAssignment {
  ...
  assignedVehicle: Partial<AssignedVehicle> | null;
  invitedUser: Partial<UserColumn> | null;
}
...
class Resource {
  ...
  static assignmentWithVehicleToJson(assignment: Partial<VehicleWithAssignment> | null | undefined): Partial<VehicleWithAssignment> | null {
    ...
    return {
      ...
      assignedVehicle: this.assignmentToJson(assignment.assignedVehicle),
      invitedUser: assignment.invitedUser ?? null,
    };
  }
